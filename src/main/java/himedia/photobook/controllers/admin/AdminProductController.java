...
public class AdminProductController {
	...
	public String updateProduct(@ModelAttribute("albumId") String albumId, @ModelAttribute("material") String material,
			@ModelAttribute("color") String color, @ModelAttribute("albumSize") String albumSize,
			@ModelAttribute("price") Long price, @RequestParam("changeImg") MultipartFile changeImg, Model model) {
	...
	public String addProduct(@ModelAttribute("albumId") String albumId, @ModelAttribute("material") String material,
			@ModelAttribute("color") String color, @ModelAttribute("albumSize") String albumSize,
			@ModelAttribute("albumPrice") Long albumPrice, @RequestParam("fileUploader") MultipartFile multipartFile,
			Model model) {
		AlbumVo albumVo = new AlbumVo();
		albumVo.setAlbumId(albumId);
		albumVo.setMaterial(material);
