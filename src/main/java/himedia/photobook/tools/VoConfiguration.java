...
public class VoConfiguration {
	...
	public List<String> getAlbumMaterialList() {
		List<String> materialList = Stream.of(ALBUM_MATERIAL.values()).map(Enum::name).collect(Collectors.toList());
		return materialList;
	}
	...
	public List<String> getAlbumColorList() {
		List<String> colorList = Stream.of(ALBUM_COLOR.values()).map(Enum::name).collect(Collectors.toList());
		return colorList;
	}
	...
	public List<String> getAlbumSizeList() {
		List<String> sizeList = Stream.of(ALBUM_SIZE.values()).map(Enum::name).collect(Collectors.toList());
		return sizeList;
	}
}
