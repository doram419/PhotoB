...
public class UsersOrderController {
	...
	public String detail(@RequestParam("ordersId") String ordersId, @RequestParam("albumId") String albumId,
			@RequestParam("orderDate") String orderDate, @RequestParam("oQuantity") Long oQuantity,
			@RequestParam("userId") String userId, @RequestParam("status") String status, Model model) {
