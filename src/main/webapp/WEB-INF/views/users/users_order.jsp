							...
							<td>
								<form method="post"
									...
									<input type="hidden" name="ordersId"
										value="${infoMap['ordersVo'].orderId}" /> <input
										type="hidden" name="userId"
										value="${infoMap['ordersVo'].userId}" /> <input type="hidden"
										name="albumId" value="${infoMap['ordersVo'].albumId}" /> <input
										type="hidden" name="orderDate"
										value="${infoMap['ordersVo'].orderDate}" /> <input
										type="hidden" name="oQuantity"
										value="${infoMap['ordersVo'].oQuantity}" /> <input
										type="hidden" name="status" value="${infoMap['status']}" />
									<button>조회</button>
								</form>
							</td>
							<td><c:choose>
