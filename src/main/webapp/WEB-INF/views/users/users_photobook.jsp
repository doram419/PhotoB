...
<head>
    ...
    <link type="text/css" rel="stylesheet" href='<c:url value="/css/photobook_style.css"/>'>
</head>
<body>
        ...
        <section class="photobook-container">
            ...
            <form action="<c:url value='/users/create_photobook'/>" method="post">
                <div class="form-group">
                    <label for="material">커버 재질:</label>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="oQuantity" name="oQuantity" min="1" max="100" value="1" required>
                </div>
                <div class="form-group">
